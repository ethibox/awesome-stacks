...
main() {
  local apps=(${@:-traefik nextcloud discourse rocketchat n8n mastodon mattermost metabase jitsi kanboard matomo mediawiki grist zammad wordpress nocobase wekan mautic calendso freescout})
  for app in "${apps[@]}"; do
    update_app "$app"
  done
}
